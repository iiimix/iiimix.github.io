...
export const themeConfig: DefaultTheme.Config = {
  ...
  // 编辑链接配置
  editLink: {
    pattern: 'https://github.com/iiimix/iiimix.github.io/edit/main/docs/:path',
    text: 'Contact me'
  },
  // 搜索配置（二选一）
  search: {
  ...
  // 导航栏右侧社交链接配置
  socialLinks: [
    { icon: 'github', link: 'https://github.com/iiimix/iiimix.github.io' },
    {
      icon: {
  ...
  footerConfig: {
    ...
    icpRecordCode: '粤ICP备2024262929号', // ICP备案号
    publicSecurityRecordCode: '', // 联网备案号
    copyright: `Copyright ©${new Date().getFullYear()} iiimix` // 版权信息
  }
}